...
- `decision`: `.opencode-context/decisions/`에 decision record 작성

평가:

command 구성은 `.opencode-context/` 운영 정책과 일치합니다. 보고서, 세션 체크포인트, 결정 기록을 분리하는 현재 AGENTS.md 정책과도 맞습니다.
...
- 계약 경계 변경: `.opencode-context/contracts/` 확인 후 사용자 승인 필요
