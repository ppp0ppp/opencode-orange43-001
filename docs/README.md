...
사용자와 에이전트는 큰 맥락의 논의, 보고서, 체크포인트를 Markdown으로 주고받습니다. 이 중 프로젝트의 공식 문서로 장기 보존할 내용은 `docs/`에 두고, 작업 중 맥락과 중간 산출물은 `.project-context/`에 둡니다.
...
작업 중 논의, 분석 보고서, 세션 체크포인트, 사용자 제공 입력 자료는 `.project-context/`를 사용합니다.
